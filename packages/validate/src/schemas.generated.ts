...
export const feedSchema: AnySchemaObject = {
  ...
  "properties": {
    ...
    "license": {
      ...
      "$ref": "https://opentechevents.org/schema/v0.2/event.schema.json#/$defs/license",
      "examples": [
        "CC-BY-4.0",
        "CC0-1.0"
      ]
    ...
    "updatedAt": {
      ...
      "$ref": "https://opentechevents.org/schema/v0.2/event.schema.json#/$defs/instant",
      "examples": [
    ...
    "events": {
      ...
      "type": "array",
      "items": {
        "$ref": "https://opentechevents.org/schema/v0.2/event.schema.json#/$defs/event"
      }
    }
  }
};
