...
`;var ie=class extends HTMLElement{static observedAttributes=["feed","limit","theme","lang","show-past","layout","fields","placeholder-image","event-click","event-actions","sort","empty-message"];#u;#r;#o;#n;#l=!1;#a=[];#d;#s=new WeakMap;#i="idle";#c="";#m=0;#t;#f=[];#v;#g;#h;#p=0;#x=!1;constructor(){super();let t=this.attachShadow({mode:"open"});this.#u=document.createElement("style"),this.#u.textContent=ze,this.#r=document.createElement("div"),this.#r.className="ote-events",t.append(this.#u,this.#r)}connectedCallback(){this.#l?this.#e():this.#b()}disconnectedCallback(){this.#y()}attributeChangedCallback(t){this.isConnected&&(t==="feed"?this.#b():this.#e())}get feedData(){return this.#n}set feedData(t){this.#E(t)}get events(){if(this.#n)return Array.isArray(this.#n)?this.#n:this.#n.events}set events(t){this.#E(t)}get event(){return this.events?.[0]}set event(t){this.#E(t==null?t:[t])}get eventActions(){return this.#f}set eventActions(t){this.#f=Array.isArray(t)||typeof t=="function"?t:[],this.isConnected&&this.#e()}get eventClassName(){return this.#v}set eventClassName(t){this.#v=typeof t=="function"?t:void 0,this.isConnected&&this.#e()}get eventBadges(){return this.#g}set eventBadges(t){this.#g=typeof t=="function"?t:void 0,this.isConnected&&this.#e()}async#b(){if(this.#l)return;let t=this.getAttribute("feed");if(!t){this.#i="error",this.#c='Missing required "feed" attribute.',this.#t=void 0,this.#e();return}this.#i="loading",this.#e();let n=++this.#m;try{let i=await fetch(t);if(!i.ok)throw new Error(`HTTP ${i.status}`);let r=await i.text(),o=JSON.parse(r),c=M(o);if(n!==this.#m)return;this.#o=c,this.#n=o,this.#l=!1,this.#a=re(o),this.#d=We(o,t),this.#s=He(c,this.#a,this.#d),this.#i="loaded",this.#t=void 0}catch(i){if(n!==this.#m)return;this.#i="error",this.#c=i instanceof Error?i.message:String(i),this.#t=void 0}this.#e()}#E(t){if(this.#m++,t==null){this.#n=void 0,this.#l=!1,this.#o=void 0,this.#a=[],this.#d=void 0,this.#s=new WeakMap,this.#c="",this.#t=void 0,this.isConnected&&this.#b();return}this.#n=t,this.#l=!0;try{this.#o=M(t),this.#a=re(t),this.#d=We(t),this.#s=He(this.#o,this.#a,this.#d),this.#i="loaded",this.#c="",this.#t=void 0}catch(n){this.#o=void 0,this.#a=[],this.#d=void 0,this.#s=new WeakMap,this.#i="error",this.#c=n instanceof Error?n.message:String(n),this.#t=void 0}this.isConnected&&this.#e()}#e(){let t=ue(le(this.getAttribute("lang")),navigator.language),n={status:this.#i,errorMessage:this.#c,feed:this.#o,lang:t,limit:ce(this.getAttribute("limit")),showPast:me(this.getAttribute("show-past")),sort:fe(this.getAttribute("sort")),layout:pe(this.getAttribute("layout")),fields:ge(this.getAttribute("fields")),placeholderImage:this.getAttribute("placeholder-image")?.trim()||void 0,emptyMessage:this.getAttribute("empty-message")?.trim()||void 0,eventClick:T(this.getAttribute("event-click")),eventActions:this.#k(),eventClassName:this.#v,eventBadges:this.#g,eventContext:i=>this.#s.get(i)??{previewEvent:i,index:-1},selectedEvent:this.#t,onEventOpen:i=>{this.dispatchEvent(new CustomEvent("ote-event-open",{detail:this.#w(void 0,i)})),T(this.getAttribute("event-click"))==="modal"&&(this.#t=i,this.#e())},onEventClose:()=>{this.#t=void 0,this.#e()},onEventAction:(i,r)=>{let o=typeof i=="string"?i:"type"in i?i.type:i.id;this.dispatchEvent(new CustomEvent("ote-event-action",{detail:this.#w(o,r)}))}};if($e(this.#r,n),n.layout==="calendar"&&n.status==="loaded"){let i=Z(n);if(i.length>0){this.#A(i,n.lang);return}}this.#y()}async#A(t,n){this.#y();let i=++this.#p;try{let r=await import(new URL("./calendar-layout.js",import.meta.url).href);if(i!==this.#p||!this.isConnected)return;this.#x||(this.#u.textContent+=r.CALENDAR_CSS,this.#x=!0);let o=this.#r.querySelector(".calendar-host");if(!o)return;o.classList.remove("ec-dark","ec-auto-dark");let c=this.getAttribute("theme");c==="dark"?o.classList.add("ec-dark"):c!=="light"&&o.classList.add("ec-auto-dark"),o.replaceChildren(),this.#h=r.renderCalendar(o,t,{lang:n,onEventClick:s=>{let d=T(this.getAttribute("event-click"));this.dispatchEvent(new CustomEvent("ote-event-open",{detail:this.#w(void 0,s)})),d==="link"&&s.link?window.open(s.link,"_blank","noopener"):d==="modal"&&(this.#t=s,this.#e())}})}catch(r){if(i!==this.#p||!this.isConnected)return;let o=this.#r.querySelector(".calendar-host");o&&(o.textContent=r instanceof Error?r.message:String(r))}}#k(){let t=ve(this.getAttribute("event-actions")),n=this.#f;return typeof n=="function"?i=>[...t,...n(i)]:[...t,...n]}#w(t,n){let i=this.#s.get(n)??{previewEvent:n,index:-1};return{...t?{action:t}:{},event:n,previewEvent:n,originalEvent:i.originalEvent,index:i.index,feed:i.feed,source:i.source}}#y(){this.#p++,this.#h?.destroy(),this.#h=void 0}};function re(e){return Array.isArray(e)?e:Array.isArray(e.events)?e.events:[]}function k(e){return typeof e=="string"&&e.trim()?e:void 0}function We(e,t){let n=re(e)[0],i=Array.isArray(e)?void 0:k(e.title??e._feedTitle),r={url:t??k(n?._feedUrl),title:i??k(n?._feedTitle)};return r.url||r.title?r:void 0}function He(e,t,n){let i=new WeakMap;return e.events.forEach((r,o)=>{let c=t[o],s={url:k(c?._feedUrl)??n?.url,title:k(c?._feedTitle)??n?.title};i.set(r,{previewEvent:r,originalEvent:c,index:o,feed:s.url||s.title?s:n,source:c?.source})}),i}function oe(){customElements.get("ote-events")||customElements.define("ote-events",ie)}oe();export{oe as defineOteEvents};
