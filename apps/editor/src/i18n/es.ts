...
export const es: Record<string, string> = {
  ...
  "dialog.recurrence.hint1":
    "Usa todo lo ya rellenado en el formulario como plantilla compartida para cada ocurrencia — solo cambia la fecha en cada evento.",
  "dialog.recurrence.frequency": "Se repite",
  "dialog.recurrence.weekly": "Cada semana",
  "dialog.recurrence.monthly": "Cada mes (día N del mes)",
  "dialog.recurrence.interval": "Cada",
  "dialog.recurrence.ordinal": "Cuál",
  "dialog.recurrence.ordinal.1": "1º",
  "dialog.recurrence.ordinal.2": "2º",
  "dialog.recurrence.ordinal.3": "3º",
  "dialog.recurrence.ordinal.4": "4º",
  "dialog.recurrence.ordinal.last": "Último",
  "dialog.recurrence.weekday": "El",
  "dialog.recurrence.weekday.mon": "lunes",
  "dialog.recurrence.weekday.tue": "martes",
  "dialog.recurrence.weekday.wed": "miércoles",
  "dialog.recurrence.weekday.thu": "jueves",
  "dialog.recurrence.weekday.fri": "viernes",
  "dialog.recurrence.weekday.sat": "sábado",
  "dialog.recurrence.weekday.sun": "domingo",
  "dialog.recurrence.from": "A partir de",
  "dialog.recurrence.until": "Hasta",
  "dialog.recurrence.untilCount": "Tras",
  "dialog.recurrence.occurrences": "ocurrencia(s)",
  "dialog.recurrence.untilDate": "Hasta la fecha",
  "dialog.recurrence.partOfHint":
    'Consejo: rellena "Parte de (serie)" en Avanzado antes de generar para que todas las ocurrencias compartan el mismo id de serie — totalmente opcional, la spec de OTE no lo exige.',
  "dialog.recurrence.empty": "No se ha generado ninguna ocurrencia — revisa los campos de recurrencia de arriba.",
  "dialog.recurrence.cappedWarning":
    "Limitado a {max} ocurrencias — vuelve a generar más adelante para continuar la serie.",
  ...
  "action.repeatSeries": "Repetir como serie…",
  "action.copy": "Copiar",
